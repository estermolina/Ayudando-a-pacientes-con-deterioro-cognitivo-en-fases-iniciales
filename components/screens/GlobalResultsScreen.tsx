        ...
        {results.length === 0 && (
          <Card className="p-12 text-center">
            <p className="text-2xl text-gray-500">
              ...
              <br />
              ¡Comienza ahora para ver tu progreso!
            </p>
          </Card>
        )}
      </main>
